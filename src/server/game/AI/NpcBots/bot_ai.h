...
enum BotItemStat
{
	...
	/* > v4 */
	BOT_ITEM_MOD_MASTERY_RATING             = 49,
	BOT_ITEM_MOD_EXTRA_ARMOR                = 50,
	BOT_ITEM_MOD_FIRE_RESISTANCE            = 51,
	BOT_ITEM_MOD_FROST_RESISTANCE           = 52,
	BOT_ITEM_MOD_HOLY_RESISTANCE            = 53,
	BOT_ITEM_MOD_SHADOW_RESISTANCE          = 54,
	BOT_ITEM_MOD_NATURE_RESISTANCE          = 55,
	BOT_ITEM_MOD_ARCANE_RESISTANCE          = 56,
	BOT_ITEM_MOD_PVP_POWER                  = 57,
	BOT_ITEM_MOD_RESIST_HOLY                = BOT_ITEM_MOD_HOLY_RESISTANCE,
	BOT_ITEM_MOD_RESIST_FIRE                = BOT_ITEM_MOD_FIRE_RESISTANCE,
	BOT_ITEM_MOD_RESIST_NATURE              = BOT_ITEM_MOD_NATURE_RESISTANCE,
	BOT_ITEM_MOD_RESIST_FROST               = BOT_ITEM_MOD_FROST_RESISTANCE,
	BOT_ITEM_MOD_RESIST_SHADOW              = BOT_ITEM_MOD_SHADOW_RESISTANCE,
	BOT_ITEM_MOD_RESIST_ARCANE              = BOT_ITEM_MOD_ARCANE_RESISTANCE,
	//END ItemProtoType.h
